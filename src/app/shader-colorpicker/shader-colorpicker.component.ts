...
export class ShaderColorpickerComponent {
  ...
  url ='assets/smooth-suzanne.*.prwm'
  ...
  ngOnInit(): void {
    ...
    this.loader.load(this.url,(geometry)=>{
      this.mesh10=new THREE.Mesh(geometry,this.material);
      // scene.add(mesh11);
      this.mesh11=new THREE.Mesh(geometry,this.material);
      this.mesh12=new THREE.Mesh(geometry,this.material);
      this.mesh10.scale.set(15,15,15);
      this.mesh11.scale.set(15,15,15);
      this.mesh12.scale.set(15,15,15);
      this.shader();
      this.render();
      this.rgbchange();
  ...
  rgbchange(){
    ...
    this.HSV_V = var_Max
     ...
     this.HSL_S = (this.HSV_S * this.HSV_V / ((h1 = (2 - this.HSV_S) * this.HSV_V) < 1 ? h1 : 2 - h1)) || 0,
        ...
        //  this.scene.children[11].position.x=X;
        //  this.scene.children[11].position.y=Y;
        //  
        this.mesh10.position.x=X;
        this.mesh10.position.y=Y;
        this.mesh11.position.x=picker;
  }
...
materialadd(){
  ...
  //      scene.add(mesh11);
  //      this.rgbchange();
  //      mesh11.scale.set(15,15,15);
  //     //  mesh10.scale.set(15,15,15);
  //     //   mesh10.position.x=100;
  //     //   mesh11 =sceneAdd(mesh10);
  //      // mesh11.position.x=pointadd();
  //     // sceneAdd(mesh10);
  //   })
  ...
  render() {
    ...
    if (intersects2.length > 0) {
      ...
      this.mesh12.position.x=point1.x;
    ...
    if (intersects3.length > 0) {
      ...
      this.mesh10.position.x=point2.x;
      this.mesh10.position.y=point2.y;
      // this.scene.children[11].position.x=point2.x;
      // this.scene.children[11].position.y=point2.y;
    //  this.mesh7.material =new THREE.MeshBasicMaterial({ color: `hsl(${this.color},100%,50%)`, });
    }
    let H=this.color;
